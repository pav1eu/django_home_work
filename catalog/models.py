...
class Product(models.Model):
    ...
    category = models.ForeignKey(on_delete=models.CASCADE, verbose_name='Категория продукта')
    price = models.IntegerField(null=True, blank=True, verbose_name='Цена')
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='Дата производства')
